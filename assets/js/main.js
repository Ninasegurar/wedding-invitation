...
document.addEventListener("DOMContentLoaded", function () {
  ...
  /* ---------- Photo gallery renderer (reused by any page with a
     [data-*-gallery] element) — masonry via CSS columns, each photo
     keeps its own natural aspect ratio, no JS sizing needed. ---------- */
  function renderGallery(selector, folder, files, emptyMessage) {
  ...
  /* ---------- OUR STORY page: engagement/personal photos ---------- */
  renderGallery(
    "[data-gallery]",
    "assets/img/gallery/",
    DATA.gallery,
  ...
  /* ---------- WEDDING PHOTOS page: photos from the day itself ---------- */
  renderGallery(
    "[data-wedding-gallery]",
    "assets/img/wedding-photos/",
    DATA.weddingPhotos,
    "Wedding photos will appear here once added to assets/img/wedding-photos/ and listed in site-data.js."
  );
